...
for the print function there is an implicit requirement (to support <<)
if the << is not supported with the specifi type, the code will still compile as long as print is not called
it means we have mandatory and optional requirements
...
## constexpr
DEF: an object or function fit for use in constant expressions
